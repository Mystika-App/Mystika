        ...
        <div className="teresa-profile">
          ...
          <div className="teresa-info">
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 14, justifyContent: "center", flexWrap: "wrap" }}>
              {[
                { url: "https://www.instagram.com/teresareyesvidente/", label: "Instagram", color: "#E1306C", icon: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" },
                { url: "https://www.facebook.com/profile.php?id=100053931032827", label: "Facebook", color: "#1877F2", icon: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
                { url: "https://www.tiktok.com/@videnteteresareyes", label: "TikTok", color: "#ffffff", icon: "M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.17 8.17 0 004.77 1.52V6.76a4.85 4.85 0 01-1-.07z" },
                { url: "https://www.youtube.com/@videnteteresareyes", label: "YouTube", color: "#FF0000", icon: "M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" },
                { url: "https://x.com/TeresaTarot", label: "X (Twitter)", color: "#ffffff", icon: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
                { url: "https://es.pinterest.com/videnteteresareyes/_profile/_created/", label: "Pinterest", color: "#E60023", icon: "M12 0C5.373 0 0 5.373 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.632-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0z" },
              ].map(({ url, label, color, icon }) => (
                <a key={label} href={url} target="_blank" rel="noopener noreferrer" title={label}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = color; e.currentTarget.style.transform = "scale(1.1)"; }}
...
function ChatSection({
  ...
  const startChat = (plan) => {
    ...
    // Check if continuing a previous conversation
    let prevMessages = null;
    let prevHistory = null;
    try {
      const pm = sessionStorage.getItem("mystika_prev_messages");
      const ph = sessionStorage.getItem("mystika_prev_history");
      if (pm && ph) {
        prevMessages = JSON.parse(pm);
        prevHistory = JSON.parse(ph);
        sessionStorage.removeItem("mystika_prev_messages");
        sessionStorage.removeItem("mystika_prev_history");
      }
    } catch(e) {}

    if (prevMessages && prevHistory) {
      // Continuar conversación previa
      const continueMsg = { from: "tarot", text: "El tiempo se ha renovado ✨ Continúa tu consulta donde lo dejaste." };
      setMessages([...prevMessages, continueMsg]);
      setHistory([...prevHistory, { role: "assistant", content: continueMsg.text }]);
    } else {
      // Nueva conversación
      const welcome = {
        role: "assistant",
      ...
      <div className="chat-container">
        <div className="chat-ui">
          <div className="session-ended">
            ...
            {/* Main actions */}
            <div style={{ display: "flex", flexDirection: "column", gap: 10, width: "100%", maxWidth: 320, margin: "0 auto 24px" }}>

              {/* Continuar conversación */}
              <button className="btn-primary" onClick={() => {
                // Guarda el historial actual antes de resetear
                const savedMessages = [...messages];
                const savedHistory = [...history];
                // Vuelve a la pantalla de pago manteniendo el historial
                setPhase("payment");
                // El historial se restaurará cuando inicie la nueva sesión
                // guardándolo en sessionStorage temporalmente
                try {
                  sessionStorage.setItem("mystika_prev_messages", JSON.stringify(savedMessages));
                  sessionStorage.setItem("mystika_prev_history", JSON.stringify(savedHistory));
                } catch(e) {}
              }}>
              ...
              <button
                ...
                style={{
                  padding: "13px 28px",
                  background: "linear-gradient(135deg, rgba(107,33,168,0.5), rgba(168,85,247,0.3))",
              ...
              {/* Volver al menú */}
              <button className="btn-secondary" onClick={onGoHome}>← Menú principal</button>
            </div>

            {/* Redes sociales */}
            <div style={{ borderTop: "1px solid rgba(212,175,55,0.1)", paddingTop: 20 }}>
              <p style={{ fontFamily: "var(--font-heading)", fontSize: "0.6rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(212,175,55,0.4)", marginBottom: 14 }}>
                Sigue a Teresa Reyes
              </p>
              <div style={{ display: "flex", justifyContent: "center", gap: 16 }}>
                {[
                  { url: "https://www.instagram.com/teresareyesvidente/", icon: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z", color: "#E1306C", label: "Instagram" },
                  { url: "https://www.facebook.com/profile.php?id=100053931032827", icon: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z", color: "#1877F2", label: "Facebook" },
                  ...
                  <a key={label} href={url} target="_blank" rel="noopener noreferrer"
                    ...
                    onMouseEnter={e => { e.currentTarget.style.borderColor = color; e.currentTarget.style.background = "rgba(45,16,84,0.9)"; }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(212,175,55,0.2)"; e.currentTarget.style.background = "rgba(26,10,46,0.8)"; }}
                  >
